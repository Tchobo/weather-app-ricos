...
const getWeatherData = async () => {
  try {
    console.log("lat", route.query.lat);
    const weatherData = await axios.get(`https://api.openweathermap.org/data/2.5/onecall?lat=${route.query.lat}&lon=${route.query.lng}&exclude={part}&appid=${apiKey}&units=imperial`)
